  ...
  const links = [
    {
      ...
      title: "Feature",
      child: [
        { title: "Travel Information", link: "/" },
        { title: "Travel Insurance", link: "/" },
        { title: "Reservation", link: "/" },
        { title: "Tour Packaging and Costing", link: "/" },
        { title: "Currency Services", link: "/" },
      ],
    },
    {
      id: 2,
    ...
    <section className="footer section">
      <Container>
        <Row>
          <Col lg={4}>
            <div className="mb-4">
              <p className="text-muted mt-4 mb-2">Travist@gmail.com</p>
          ...
          <Col md={12}>
            <div className="text-center text-muted">
              <p className="mb-0 f-15">
                2022 © Travist. Design by Ashwin Dhuriya
              </p>
            </div>
          </Col>
        </Row>
